...
Once your Vercel site is live at `https://api.southafricassoul.co.za`, follow these steps to finish the link.

### 1. Update the Webhook
1. Go to [Meta for Developers](https://developers.facebook.com/apps/).
2. Select your app and go to **WhatsApp > Configuration**.
3. Click **Edit** next to "Webhook".
4. **Callback URL:** `https://api.southafricassoul.co.za/api/webhook/whatsapp`
